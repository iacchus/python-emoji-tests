...
Welcome to ``python-emoji-tests`` contributor's guide.
...
If you experience bugs or general issues with ``python-emoji-tests``, please have a look
...
You can help improve ``python-emoji-tests`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``python-emoji-tests`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``python-emoji-tests``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n python-emoji-tests python=3 six virtualenv pytest pytest-cov
    conda activate python-emoji-tests
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/python-emoji-tests.git
    cd python-emoji-tests
...
#. Install |pre-commit|_::
   ...
   ``python-emoji-tests`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/python-emoji-tests
.. _issue tracker: https://github.com/<USERNAME>/python-emoji-tests/issues
.. <-- end -->
